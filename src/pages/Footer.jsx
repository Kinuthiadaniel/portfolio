...
function Footer() {
    return (
        ...
        <div >
            ...
            <div className="flex justify-center">
                <a href="https://www.linkedin.com/in/daniel-kinuthia-274ba629b/" className="mr-2" rel='' target="_blank">   <Avatar
                ...
                <a href="https://github.com/Kinuthiadaniel" className="mr-2" target="_blank">   <Avatar
